...
Use Case #16: Asthma Attack Prediction
...
print("="*80)
print("ASTHMA ATTACK PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/016_asthma_attack'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ASTHMA ATTACK PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

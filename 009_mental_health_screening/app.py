...
Use Case #9: Mental Health Screening
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/009_mental_health_screening'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("MENTAL HEALTH SCREENING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

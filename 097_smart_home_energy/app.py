...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/097_smart_home_energy'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SMART HOME ENERGY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

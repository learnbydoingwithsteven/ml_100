"""
Demand Forecasting
Use Case #42: Demand Forecasting
Algorithm: ARIMA
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/042_demand_forecasting'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DEMAND FORECASTING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

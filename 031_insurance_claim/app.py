...
Use Case #31: Insurance Claim Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/031_insurance_claim'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("INSURANCE CLAIM PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

"""
Diabetes Prediction
Use Case #4: Diabetes Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/004_diabetes_prediction'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DIABETES PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

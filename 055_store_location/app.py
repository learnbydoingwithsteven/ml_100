...
Use Case #55: Store Location Optimization
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/055_store_location'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("STORE LOCATION OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #48: Customer Service Chatbot
Algorithm: NLP
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/048_customer_service_chatbot'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CUSTOMER SERVICE CHATBOT - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

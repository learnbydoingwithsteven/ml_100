...
Use Case #41: Product Recommendation
...
if "CollaborativeFiltering" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING COLLABORATIVEFILTERING MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/041_product_recommendation'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PRODUCT RECOMMENDATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

"""
Route Optimization
Use Case #63: Route Optimization
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/063_route_optimization'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ROUTE OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

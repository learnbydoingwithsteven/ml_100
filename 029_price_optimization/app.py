"""
Price Optimization
Use Case #29: Price Optimization
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/029_price_optimization'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PRICE OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

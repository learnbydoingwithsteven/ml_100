...
Use Case #7: Medical Image Classification
Algorithm: CNN
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/007_medical_image_classification'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("MEDICAL IMAGE CLASSIFICATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

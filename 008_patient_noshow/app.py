...
Use Case #8: Patient No-Show Prediction
...
print("="*80)
print("PATIENT NO-SHOW PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/008_patient_noshow'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PATIENT NO-SHOW PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

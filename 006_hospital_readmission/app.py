...
Use Case #6: Hospital Readmission
Algorithm: XGBoost
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/006_hospital_readmission'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("HOSPITAL READMISSION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

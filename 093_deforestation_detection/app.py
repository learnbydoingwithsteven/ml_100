...
Use Case #93: Deforestation Detection
Algorithm: CNN
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/093_deforestation_detection'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DEFORESTATION DETECTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

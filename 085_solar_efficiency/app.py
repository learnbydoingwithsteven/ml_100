...
Use Case #85: Solar Panel Efficiency
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/085_solar_efficiency'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SOLAR PANEL EFFICIENCY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

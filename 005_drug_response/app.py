...
Use Case #5: Drug Response Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/005_drug_response'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DRUG RESPONSE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

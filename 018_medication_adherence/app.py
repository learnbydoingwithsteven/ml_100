...
Use Case #18: Medication Adherence
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/018_medication_adherence'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("MEDICATION ADHERENCE - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

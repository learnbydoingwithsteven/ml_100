...
Use Case #77: Toll Collection Optimization
...
print("="*80)
print("TOLL COLLECTION OPTIMIZATION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/077_toll_collection'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("TOLL COLLECTION OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

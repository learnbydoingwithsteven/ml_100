...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/024_fraud_detection'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("FRAUD DETECTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

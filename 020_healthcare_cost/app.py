...
Use Case #20: Healthcare Cost Prediction
...
print("="*80)
print("HEALTHCARE COST PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/020_healthcare_cost'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("HEALTHCARE COST PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

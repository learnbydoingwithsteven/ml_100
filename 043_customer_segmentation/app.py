...
Use Case #43: Customer Segmentation
Algorithm: KMeans
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/043_customer_segmentation'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CUSTOMER SEGMENTATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

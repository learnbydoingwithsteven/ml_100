...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/060_visual_search'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("VISUAL SEARCH - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

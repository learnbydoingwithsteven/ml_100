...
Use Case #66: Accident Risk Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/066_accident_risk'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ACCIDENT RISK PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #32: Portfolio Optimization
Algorithm: MeanVariance
"""
...
print("\n" + "="*80)
print("TRAINING MEANVARIANCE MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/032_portfolio_optimization'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PORTFOLIO OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

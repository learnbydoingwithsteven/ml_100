...
Use Case #100: Carbon Footprint Estimation
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/100_carbon_footprint'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CARBON FOOTPRINT ESTIMATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #51: Cross-sell Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/051_cross_sell'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CROSS-SELL PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

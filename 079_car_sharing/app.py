...
Use Case #79: Car Sharing Availability
...
print("="*80)
print("CAR SHARING AVAILABILITY")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/079_car_sharing'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CAR SHARING AVAILABILITY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

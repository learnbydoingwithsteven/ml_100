"""
Bike Sharing Demand
Use Case #69: Bike Sharing Demand
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/069_bike_sharing'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("BIKE SHARING DEMAND - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

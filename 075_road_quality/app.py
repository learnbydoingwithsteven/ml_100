...
Use Case #75: Road Quality Assessment
Algorithm: CNN
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/075_road_quality'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ROAD QUALITY ASSESSMENT - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

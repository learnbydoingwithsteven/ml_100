...
Use Case #28: Market Basket Analysis
Algorithm: Apriori
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/028_market_basket'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("MARKET BASKET ANALYSIS - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #76: Pedestrian Flow Prediction
...
print("="*80)
print("PEDESTRIAN FLOW PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/076_pedestrian_flow'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PEDESTRIAN FLOW PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

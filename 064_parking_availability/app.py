...
Use Case #64: Parking Availability
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/064_parking_availability'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PARKING AVAILABILITY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

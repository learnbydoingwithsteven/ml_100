...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/038_budget_allocation'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("BUDGET ALLOCATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

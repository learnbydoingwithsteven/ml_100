...
Use Case #22: Loan Default Prediction
Algorithm: XGBoost
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/022_loan_default'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("LOAN DEFAULT PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #11: Kidney Disease Detection
Algorithm: SVM
"""
...
print("="*80)
print("KIDNEY DISEASE DETECTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/011_kidney_disease'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("KIDNEY DISEASE DETECTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

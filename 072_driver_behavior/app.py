...
Use Case #72: Driver Behavior Analysis
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/072_driver_behavior'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DRIVER BEHAVIOR ANALYSIS - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

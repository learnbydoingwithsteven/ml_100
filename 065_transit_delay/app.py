...
Use Case #65: Public Transit Delay
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/065_transit_delay'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PUBLIC TRANSIT DELAY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

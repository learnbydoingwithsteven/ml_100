...
Use Case #87: Wildfire Risk Prediction
...
print("="*80)
print("WILDFIRE RISK PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/087_wildfire_risk'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("WILDFIRE RISK PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

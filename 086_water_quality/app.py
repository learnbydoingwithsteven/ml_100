...
Use Case #86: Water Quality Monitoring
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/086_water_quality'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("WATER QUALITY MONITORING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #81: Crop Yield Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/081_crop_yield'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CROP YIELD PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

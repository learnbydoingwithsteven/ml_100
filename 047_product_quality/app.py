...
Use Case #47: Product Quality Prediction
...
print("="*80)
print("PRODUCT QUALITY PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/047_product_quality'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PRODUCT QUALITY PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

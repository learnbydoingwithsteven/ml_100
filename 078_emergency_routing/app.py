...
Use Case #78: Emergency Vehicle Routing
Algorithm: DijkstraOptimized
"""
...
if "DijkstraOptimized" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING DIJKSTRAOPTIMIZED MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/078_emergency_routing'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EMERGENCY VEHICLE ROUTING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

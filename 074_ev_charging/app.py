"""
EV Charging Demand
Use Case #74: EV Charging Demand
Algorithm: LSTM
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/074_ev_charging'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EV CHARGING DEMAND - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

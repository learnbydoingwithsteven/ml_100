...
Use Case #44: Review Sentiment Analysis
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/044_review_sentiment'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("REVIEW SENTIMENT ANALYSIS - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

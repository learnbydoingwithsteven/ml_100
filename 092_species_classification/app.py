...
Use Case #92: Species Classification
Algorithm: CNN
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/092_species_classification'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SPECIES CLASSIFICATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #83: Air Quality Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/083_air_quality'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("AIR QUALITY PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

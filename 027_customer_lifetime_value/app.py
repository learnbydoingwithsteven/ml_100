...
Use Case #27: Customer Lifetime Value
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/027_customer_lifetime_value'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CUSTOMER LIFETIME VALUE - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

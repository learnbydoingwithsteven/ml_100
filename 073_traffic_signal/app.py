...
Use Case #73: Traffic Signal Optimization
...
if "ReinforcementLearning" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING REINFORCEMENTLEARNING MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/073_traffic_signal'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("TRAFFIC SIGNAL OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

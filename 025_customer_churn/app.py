...
Use Case #25: Customer Churn Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/025_customer_churn'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CUSTOMER CHURN PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

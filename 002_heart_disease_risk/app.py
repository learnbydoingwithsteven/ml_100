...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/002_heart_disease_risk'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("HEART DISEASE RISK - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

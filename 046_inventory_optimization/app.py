...
Use Case #46: Inventory Optimization
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/046_inventory_optimization'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("INVENTORY OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #84: Energy Consumption Forecasting
Algorithm: ARIMA
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/084_energy_consumption'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ENERGY CONSUMPTION FORECASTING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

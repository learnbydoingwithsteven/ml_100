...
Use Case #96: Waste Management Optimization
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/096_waste_management'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("WASTE MANAGEMENT OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

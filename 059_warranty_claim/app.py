...
Use Case #59: Warranty Claim Prediction
...
print("="*80)
print("WARRANTY CLAIM PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/059_warranty_claim'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("WARRANTY CLAIM PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

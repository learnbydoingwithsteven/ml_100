...
Use Case #80: Maritime Route Planning
...
if "GeneticAlgorithm" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING GENETICALGORITHM MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/080_maritime_route'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("MARITIME ROUTE PLANNING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

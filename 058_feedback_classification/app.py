...
Use Case #58: Customer Feedback Classification
...
print("="*80)
print("CUSTOMER FEEDBACK CLASSIFICATION")
print("="*80)
...
percentiles = np.linspace(0, 100, 7)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/058_feedback_classification'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CUSTOMER FEEDBACK CLASSIFICATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

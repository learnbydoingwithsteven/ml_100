...
Use Case #21: Credit Score Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/021_credit_score'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CREDIT SCORE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #12: Liver Disease Diagnosis
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/012_liver_disease'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("LIVER DISEASE DIAGNOSIS - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

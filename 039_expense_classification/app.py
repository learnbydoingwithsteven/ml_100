...
Use Case #39: Expense Category Classification
...
print("="*80)
print("EXPENSE CATEGORY CLASSIFICATION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/039_expense_classification'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EXPENSE CATEGORY CLASSIFICATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

"""
Vehicle Maintenance
Use Case #67: Vehicle Maintenance
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/067_vehicle_maintenance'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("VEHICLE MAINTENANCE - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

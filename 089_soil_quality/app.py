...
Use Case #89: Soil Quality Assessment
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/089_soil_quality'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SOIL QUALITY ASSESSMENT - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

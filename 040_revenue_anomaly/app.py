...
Use Case #40: Revenue Anomaly Detection
...
if "IsolationForest" in ["SVM", "KMeans"]:
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/040_revenue_anomaly'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("REVENUE ANOMALY DETECTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

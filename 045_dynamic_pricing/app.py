...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/045_dynamic_pricing'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("DYNAMIC PRICING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

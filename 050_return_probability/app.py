"""
Return Probability
Use Case #50: Return Probability
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/050_return_probability'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("RETURN PROBABILITY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

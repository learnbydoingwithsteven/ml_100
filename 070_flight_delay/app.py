...
Use Case #70: Flight Delay Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/070_flight_delay'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("FLIGHT DELAY PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

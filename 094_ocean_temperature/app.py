...
Use Case #94: Ocean Temperature Prediction
Algorithm: LSTM
"""
...
print("="*80)
print("OCEAN TEMPERATURE PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/094_ocean_temperature'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("OCEAN TEMPERATURE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

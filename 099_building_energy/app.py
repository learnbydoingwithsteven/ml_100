...
Use Case #99: Building Energy Efficiency
...
print("="*80)
print("BUILDING ENERGY EFFICIENCY")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/099_building_energy'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("BUILDING ENERGY EFFICIENCY - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

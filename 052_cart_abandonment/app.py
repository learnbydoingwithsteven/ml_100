...
Use Case #52: Shopping Cart Abandonment
...
print("="*80)
print("SHOPPING CART ABANDONMENT")
print("="*80)
...
if "LogisticRegression" in ["SVM", "KMeans"]:
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/052_cart_abandonment'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SHOPPING CART ABANDONMENT - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

"""
Pneumonia Detection
Use Case #13: Pneumonia Detection
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/013_pneumonia_detection'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PNEUMONIA DETECTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

"""
Size Recommendation
Use Case #49: Size Recommendation
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/049_size_recommendation'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SIZE RECOMMENDATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

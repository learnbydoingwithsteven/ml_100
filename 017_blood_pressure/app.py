...
Use Case #17: Blood Pressure Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/017_blood_pressure'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("BLOOD PRESSURE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

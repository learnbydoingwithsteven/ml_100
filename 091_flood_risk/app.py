...
Use Case #91: Flood Risk Assessment
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/091_flood_risk'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("FLOOD RISK ASSESSMENT - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

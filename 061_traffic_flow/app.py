...
Use Case #61: Traffic Flow Prediction
Algorithm: LSTM
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/061_traffic_flow'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("TRAFFIC FLOW PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

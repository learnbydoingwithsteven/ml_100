...
Use Case #71: Cargo Load Optimization
...
if "LinearProgramming" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING LINEARPROGRAMMING MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/071_cargo_load'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CARGO LOAD OPTIMIZATION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #33: Currency Exchange Prediction
Algorithm: LSTM
"""
...
print("="*80)
print("CURRENCY EXCHANGE PREDICTION")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/033_currency_exchange'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("CURRENCY EXCHANGE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

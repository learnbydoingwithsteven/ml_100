"""
Employee Attrition
Use Case #35: Employee Attrition
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/035_employee_attrition'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EMPLOYEE ATTRITION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #34: Invoice Payment Prediction
...
print("="*80)
print("INVOICE PAYMENT PREDICTION")
print("="*80)
...
if "GradientBoosting" in ["SVM", "KMeans"]:
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/034_invoice_payment'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("INVOICE PAYMENT PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

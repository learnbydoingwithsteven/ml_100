...
Use Case #53: Product Search Ranking
Algorithm: LearningToRank
"""
...
score = (feature_1 * 0.3 + feature_2 * 0.2 + feature_3 * 0.15)
...
if "LearningToRank" in ["SVM", "KMeans"]:
...
print("\n" + "="*80)
print("TRAINING LEARNINGTORANK MODEL")
print("="*80)
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/053_product_search_ranking'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PRODUCT SEARCH RANKING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #15: Alzheimer's Progression
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/015_alzheimers_progression'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("ALZHEIMER'S PROGRESSION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

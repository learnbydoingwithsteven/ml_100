...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/026_sales_forecasting'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SALES FORECASTING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #23: Stock Price Prediction
Algorithm: LSTM
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/023_stock_price'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("STOCK PRICE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/057_product_bundling'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("PRODUCT BUNDLING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

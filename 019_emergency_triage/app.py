...
Use Case #19: Emergency Room Triage
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/019_emergency_triage'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EMERGENCY ROOM TRIAGE - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #62: Ride Demand Prediction
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/062_ride_demand'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("RIDE DEMAND PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

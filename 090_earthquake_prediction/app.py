...
Use Case #90: Earthquake Prediction
Algorithm: LSTM
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/090_earthquake_prediction'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("EARTHQUAKE PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #56: Seasonal Demand Prediction
Algorithm: SARIMA
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/056_seasonal_demand'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SEASONAL DEMAND PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #14: Sepsis Early Warning
Algorithm: XGBoost
"""
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/014_sepsis_warning'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("SEPSIS EARLY WARNING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

...
Use Case #68: Fuel Consumption Prediction
...
if "LinearRegression" in ["SVM", "KMeans"]:
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/068_fuel_consumption'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("FUEL CONSUMPTION PREDICTION - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")

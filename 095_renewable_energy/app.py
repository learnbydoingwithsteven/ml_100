...
Use Case #95: Renewable Energy Forecasting
...
plt.tight_layout()
output_dir = 'c:/Users/wjbea/Downloads/learnbydoingwithsteven/ml_100/095_renewable_energy'
...
with open(f'{output_dir}/results.txt', 'w') as f:
    f.write("="*80 + "\n")
    f.write("RENEWABLE ENERGY FORECASTING - DETAILED RESULTS\n")
    f.write("="*80 + "\n\n")
